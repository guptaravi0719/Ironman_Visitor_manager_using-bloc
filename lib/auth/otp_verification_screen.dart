...
class _OtpVerificationScreenState extends State<OtpVerificationScreenState> {
  ...
  void initState() {
    ...
    _nexmoSmsVerificationUtil.initNexmo("a00283e7", "tq1uycJrrdw5C101");
  }
  ...
  void _submit() {
      ...
      showLoader();
      try {
        var verification = _nexmoSmsVerificationUtil
...
//        )
  ...
  void startTimer() {
    ...
    var sub = CountDown(new Duration(seconds: 60)).stream.listen(null);
