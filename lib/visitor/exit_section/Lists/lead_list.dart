...
class _LeadListState extends State<LeadList> {
  ...
  @override
  void initState() {
    _stream=Firestore.instance.collection("locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/91Lead").snapshots();
    super.initState();
  }
                                ...
                                children: <Widget>[
                                  ...
                                  RaisedButton(child: Text("EXIT"),
                                    onPressed: () {
                                      try {
                                        Firestore.instance
                                            .collection('locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/91Lead')
                                            .document(
