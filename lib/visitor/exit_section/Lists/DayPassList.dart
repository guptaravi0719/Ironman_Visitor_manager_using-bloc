...
class _DayPassListState extends State<DayPassList> {
  ...
  @override
  void initState() {
    _stream=Firestore.instance.collection("locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/daypass").snapshots();
    super.initState();
  }
                                ...
                                children: <Widget>[
                                  ...
                                  RaisedButton(child: Text("EXIT"),
                                    onPressed: () {
                                      try {
                                        Firestore.instance
                                            .collection('locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/daypass')
                                            .document(
