...
class _CouriersListState extends State<CouriersList> {
  ...
  @override
  void initState() {
    _stream=Firestore.instance.collection("locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/couriers").snapshots();
    super.initState();
  }
                                ...
                                children: <Widget>[
                                  ...
                                  RaisedButton(child: Text("EXIT"),
                                    onPressed: () {
                                      try {
                                        Firestore.instance
                                            .collection('locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/couriers')
                                            .document(
