...
class _VendorsListState extends State<VendorsList> {
  ...
  @override
  void initState() {
    _stream=Firestore.instance.collection("locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/vendors").snapshots();
    super.initState();
  }
                                ...
                                children: <Widget>[
                                  ...
                                  RaisedButton(child: Text("EXIT"),
                                    onPressed: () {
                                      try {
                                        Firestore.instance
                                            .collection('locations/okhla/people/${DateFormat("dd-MM-yyyy").format(now)}/vendors')
                                            .document(
